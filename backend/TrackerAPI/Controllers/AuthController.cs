...
public class AuthController : ControllerBase
{
    ...
    private static List<Category> GetDefaultCategories(int userId) => new()
    {
        ...
        new Category { UserId = userId, Name = "Health", Icon = "💊", Color = "#00BCD4", Type = "expense", IsDefault = true },
        new Category { UserId = userId, Name = "Entertainment", Icon = "🎬", Color = "#E91E63", Type = "expense", IsDefault = true },
        new Category { UserId = userId, Name = "Education", Icon = "📚", Color = "#3F51B5", Type = "expense", IsDefault = true },
        new Category { UserId = userId, Name = "Gifts", Icon = "🎁", Color = "#F44336", Type = "expense", IsDefault = true },
